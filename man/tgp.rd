...
\description{
A plotting function producing non-parametric analogues of the IRF 
...
\arguments{
  \item{choices}{A matrix of responses to multiple-choice items: persons as rows, items as columns. As a rare exception in \code{irtoys}, responses must not be recoded to 0/1, and there may be missing responses.}
  \item{key}{A vector containing the key (correct answers) to the items in \code{choices}.}
  \item{item}{A single number pointing to the item (column of \code{choices}) to plot.}
