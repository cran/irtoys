...
\arguments{
  ...
  [,3] asymptote \eqn{c}.}
  \item{mu}{Mean of the apriori distribution. Ignored when \code{method="ML"}. Default is 0.}
  \item{sigma}{Standard deviation of the apriori distribution. Ignored when \code{method="ML"}. Default is 1.}
  \item{method}{\code{"ML"} for maximum likelihood or \code{"BM"} for Bayes Modal estimation. Default is \code{"ML"}, in which case any values for \code{mu} and \code{sigma} will be ignored.}
}
\value{A matrix with the ability estimates in column 1 and their standard errors of measurement (SEM) in column 2, and the number of non-missing responses in column 3}
%\references{}
